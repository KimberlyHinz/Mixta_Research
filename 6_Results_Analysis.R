...
# 
# library("knitr")
# kable(strain, caption = "Table 2. The number of genes that required each phylogenetic tree model according to model testing and the lowest BIC.")
# ```
...
# 
# library("knitr")
# kable(strain, caption = "Table 3. The closest relative to the Mixta sequences for both species in the nucleotide analysis.")
# ```
