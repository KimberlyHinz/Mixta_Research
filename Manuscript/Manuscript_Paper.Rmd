...
```{r Figure4, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 4. The closest relatives to *M. calida* genes for amino acid sequences around the *M. calida* chromosome. The length and colour of the bars represent the different species to which the gene is most closely related according to genetic distance. The *M. calida* genome has 4092 genes.", fig.width=6.5, fig.height=5}
