...
author: "Kimberly N. Hinz, John Stavrinides*"
output:
  word_document:
    reference_docx: Style_RMarkdown.docx
    fig_caption: true
    # toc: true
    # toc_depth: 5
...
In contrast, only 47.8 and 47.6% of *M. calida* and *M. gaviniae* sequences were most similar to *P. septica* for the amino acid sequences (Figure 5). Instead, the genes are most similar to either *P. agglomerans* or one of the two *Erwinia* species (Figure 5). Additionally, 3.1 and 2.5% more genes were most similar to the *E. cloacae* sequences for *M. calida* and *M. gaviniae*, respectively (Figure 5). In the identity analyses, functionally equivalent amino acids were not considered. This may explain the large differences between the nucleotide and amino acid identities for which species was most similar to the *Mixta* sequences. Furthermore, every site in a nucleotide sequence has a 1:3 chance of being identical to the site at the corresponding location of a homologous gene. In contrast, there is only a 1:19 chance for amino acids. Thus, two nucleotides at the same position on two homologues are more likely to be identical. This may lead to problems when only amino acid sequences are considered, especially if functional equivalence is not considered.

The two *Mixta* species have a comparable number of genes that are most similar to *P. septica* for both nucleotide and amino acid sequences (Figure 5). Nevertheless, many genes in which the two *Mixta* species did not share the same closest relative. For the nucleotide sequences, 10.8% of the *Mixta* genes did not share the same species, and 5.6% did not share the same genus for the closest relative. For the amino acid sequences, 18.3% did not share the same species, and 11.4% did not share the same genus.

Percent identity analyses provide only the similarity of two sequences. They do not estimate evolutionary history nor penalize changes in the sequences. However, since members of a genus should be genetically similar, the percent identity analyses lend support to two taxa's relatedness.

### Spatial Patterns of Most Similar Taxa
Similar to the genetic distance analysis, spatial patterns in percent identity in the *M. calida* sequences were investigated in the nucleotide (Figure 6) and amino acid sequences (Figure 7). While no discernible patterns were seen in either figure, most genes most similar to the *Tatumella* species occur in the first half of the genome (Figures 6 and 7). Additionally, the majority of the genes most similar to *E. amylovora* also occur in the first half of the genome for the nucleotide sequences (Figure 6). The rest of the taxa occur uniformly throughout the *M. calida* genome for both nucleotide and amino acid sequences (Figures 6 and 7).
